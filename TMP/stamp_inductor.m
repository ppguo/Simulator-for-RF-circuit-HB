function [new_M,new_I,new_row] = stamp_inductor(old_M,old_I,D,Xn,delta_t);
...
new_M(length_M+1,length_M+1) = -2*L_value/delta_t;
new_I(length_M+1)= -2*L_value/delta_t*In-Vn;
new_row=length_M+1;
end
